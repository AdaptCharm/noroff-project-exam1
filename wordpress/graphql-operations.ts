...
export type AllPostsWithSlugQuery = { __typename?: "RootQuery" } & {
  posts?: Maybe<
    { __typename?: "RootQueryToPostConnection" } & {
      edges?: Maybe<
        Array<
...
export type PostBySlugQuery = { __typename?: "RootQuery" } & {
  post?: Maybe<
    { __typename?: "Post" } & Pick<Post, "content"> & PostFieldsFragment
  >;
};

export const PostFieldsFragmentDoc: DocumentNode<PostFieldsFragment, unknown> =
  {
    kind: "Document",
    definitions: [
      {
...
export const AllPostsWithSlugDocument: DocumentNode<
  ...
  definitions: [
    {
      ...
      operation: "query",
      name: { kind: "Name", value: "AllPostsWithSlug" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
...
export const GetAllPostsDocument: DocumentNode<
  GetAllPostsQuery,
...
export const PostBySlugDocument: DocumentNode<
  PostBySlugQuery,
